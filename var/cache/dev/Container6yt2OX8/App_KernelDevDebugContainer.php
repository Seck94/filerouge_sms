...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CMController' => 'getCMControllerService',
            'App\\Controller\\CompetenceController' => 'getCompetenceControllerService',
            'App\\Controller\\FormateurController' => 'getFormateurControllerService',
            'App\\Controller\\GroupeCompetenceController' => 'getGroupeCompetenceControllerService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\AdminRepository' => ['privates', 'App\\Repository\\AdminRepository', 'getAdminRepository2Service', true],
            ...
            'App\\Repository\\GroupeCompetenceRepository' => ['privates', 'App\\Repository\\GroupeCompetenceRepository', 'getGroupeCompetenceRepository2Service', true],
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lEbe0I+ONy', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gur-IbiMNN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+qbuT1PMqX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+REISGmRyZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aPnK+mEZBi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_profil_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => ['privates', 'annotated_app_entity_profil_api_platform_core_bridge_doctrine_orm_filter_boolean_filter', 'getAnnotatedAppEntityProfilApiPlatformCoreBridgeDoctrineOrmFilterBooleanFilterService', true],
            ...
            'annotated_app_entity_profil_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => '?',
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QVdR17s4Uj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8dVSPc73Kg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['debug.security.voter.App\\Security\\Voter\\CompetenceVoter'] ?? $this->load('getCompetenceVoterService'));
            yield 4 => ($this->privates['debug.security.voter.App\\Security\\Voter\\GroupeCompetenceVoter'] ?? $this->load('getGroupeCompetenceVoterService'));
            yield 5 => ($this->privates['debug.security.voter.App\\Security\\Voter\\GroupetagVoter'] ?? $this->load('getGroupetagVoterService'));
            yield 6 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ProfilVoter'] ?? $this->load('getProfilVoterService'));
            yield 7 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ReferentielVoter'] ?? $this->load('getReferentielVoterService'));
            yield 8 => ($this->privates['debug.security.voter.App\\Security\\Voter\\TagVoter'] ?? $this->load('getTagVoterService'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.collection.pagination.items_per_page' => 2,
