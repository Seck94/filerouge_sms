...
class getAnnotatedAppEntityUserApiPlatformCoreBridgeDoctrineOrmFilterBooleanFilterService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['annotated_app_entity_user_api_platform_core_bridge_doctrine_orm_filter_boolean_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\BooleanFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), NULL, ($container->privates['logger'] ?? ($container->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), ['Archivage' => NULL], ($container->privates['serializer.name_converter.metadata_aware'] ?? $container->getSerializer_NameConverter_MetadataAwareService()));
    }
}
